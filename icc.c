...
void ler_formato(int ***matriz_old, imagem *img, FILE **fp_old){
...
int main() {
    ...
    ler_formato(&matriz_old, &img, &fp_old);
    ...
    printf("The new image was generated succesfully!\n");
